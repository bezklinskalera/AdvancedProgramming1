...
//		}
    ...
    @Nested
    @TestInstance(TestInstance.Lifecycle.PER_CLASS)
    public class JUnitTestBookStoreMain {
        @BeforeAll
        public void beforeClass() {
            // Code executed before the first test method
        ...
        public void BookStoreMainMainTest1() {
            ...
            assertEquals(normalize("[(George Orwell; 1984; 6.2; 10.0%; 6.82), (Philip K. Dick; Do Androids Dream of Electric Sheep?; 3.5; 10.0%; 3.85), (Isaac Asimov; Foundation and Empire; 9.4; 10.0%; 10.34), (Ray Bradbury; Fahrenheit 451; 7.4; 10.0%; 8.14), (Aldous Huxley; A Brave New World; 6.5; 10.0%; 7.15), (Isaac Asimov; Foundation; 7.3; 10.0%; 8.03), (William Gibson; Neuromancer; 8.3; 10.0%; 9.13), (Isaac Asimov; Second Foundation; 8.1; 10.0%; 8.91), (Isaac Newton; Arithmetica Universalis; 10.5; 10.0%; 11.55)] [(Philip K. Dick; Do Androids Dream of Electric Sheep?; 3.5; 10.0%; 3.85), (Isaac Asimov; Foundation and Empire; 9.4; 10.0%; 10.34), (Ray Bradbury; Fahrenheit 451; 7.4; 10.0%; 8.14), (Isaac Asimov; Foundation; 7.3; 10.0%; 8.03), (William Gibson; Neuromancer; 8.3; 10.0%; 9.13), (Isaac Asimov; Second Foundation; 8.1; 10.0%; 8.91)] FinalPrice(Philip K. Dick, Do Androids Dream of Electric Sheep?): 3.85 FinalPrice(isaac asimov, foundation and empire): 10.34 FinalPrice(Ray Bradbury, Fahrenheit 451): 8.14 FinalPrice(Isaac Asimov, Foundation): 8.03 FinalPrice(william gibson, neuromancer): 9.13 FinalPrice(Isaac Asimov, Second Foundation): 8.91"),
                    normalize(output),
                    "\n> Error: BookStoreTest.main():"
            );
        }
        //------------------------------------------------------------------
    }
        ...
        final LauncherDiscoveryRequest request =
                LauncherDiscoveryRequestBuilder.request()
                        .selectors(
                                ...
                                selectClass(JUnitTestBookStoreMain.class))
                        .build();
