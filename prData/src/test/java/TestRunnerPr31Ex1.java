...
public class TestRunnerPr31Ex1 {
	//----------------------------------------------------------------------
	//--JUnitTest-----------------------------------------------------------
	//----------------------------------------------------------------------
	@Nested
	public static class JUnitTestDataException {
		...
		public void dataExceptionToStringTest1() {
			...
			assertEquals(normalize("data.DataException : Error Message 1"),
	...
	public static class JUnitTestData {
		...
		public void dataToStringTest1() {
			precondData(dt1);
			assertEquals(normalize("Min: 10.0, Max: 20.0, [ 5.5, 9.5, 10.5, 12.5, 13.5, 17.5, 20.5, 25.5 ], [ Joe, Mariah, Frank, Anna, John, Dolly ], Average: 13.5, StandardDeviation: 2.5495097567963922"),
		...
		public void dataToStringTest2() {
			...
			//------------------------
			assertEquals(normalize("Min: 0.0, Max: 4.0, [ 5.5, 9.5, 10.5, 12.5, 13.5, 17.5, 20.5, 25.5 ], [ Joe, Mariah, Frank, Anna, John, Dolly ], Average: ERROR, StandardDeviation: ERROR"),
	...
	//----------------------------------------------------------------------
	@Nested
	public static class JUnitTestMainData {
		@BeforeAll
		public static void beforeAll() {
			// Code executed before the first test method
		...
		public void MainDataMainTest1() {
			...
			try {
				...
				MainData.main(new String[]{"10", "20", "5", "9", "Joe", "10", "Mariah", "12", "13", "Frank", "17", "20", "Anna", "25", "John", "Dolly"});
			} finally {
				output = sysOutCapture.sysOutRelease();
			}
			assertEquals(normalize("Min : 10.0 , Max : 20.0 , [ 5.0 , 9.0 , 10.0 , 12.0 , 13.0 , 17.0 , 20.0 , 25.0 ] , [ Joe , Mariah , Frank , Anna , John , Dolly ] , Average : 14.4 , StandardDeviation : 3.6110940170535577 Min : 0.0 , Max : 4.0 , [ 5.0 , 9.0 , 10.0 , 12.0 , 13.0 , 17.0 , 20.0 , 25.0 ] , [ Joe , Mariah , Frank , Anna , John , Dolly ] , Average : ERROR , StandardDeviation : ERROR  Data error setting range"),
						 normalize(output),
		...
		public void MainDataMainTest3() {
			...
			try {
				sysOutCapture.sysOutCapture();
				MainData.main(new String[]{"10", "hello", "5", "9", "Joe", "10", "Mariah", "12", "13", "Frank", "17", "20", "Anna", "25", "John", "Dolly"});
			} finally {
				salida = sysOutCapture.sysOutRelease();
			}
			assertEquals(normalize("Error, when converting a value to a real number (For input string: \"hello\")"),
						 normalize(salida),
